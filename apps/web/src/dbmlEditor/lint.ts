...
import { DBML_TYPES } from "./language.js";
import { getSymbols, type Span } from "./symbols.js";
...
export const dbmlLinter = linter(
  ...
  },
  {
    ...
    needsRefresh: (update) => update.transactions.some((tr) => tr.effects.some((e) => e.is(setServerProblem))),
  },
);
