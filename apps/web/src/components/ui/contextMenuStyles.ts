...
export const CONTEXT_MENU_ITEM_CLASS =
  ...
  "focus-visible:bg-surface-hover focus-visible:text-text focus-visible:outline-none";
...
export const CONTEXT_MENU_DANGER_ITEM_CLASS =
  ...
  "hover:bg-danger-light hover:text-danger-hover focus-visible:bg-danger-light focus-visible:outline-none";
