...
**Hors périmètre V1, assumé** (à écrire noir sur blanc plutôt qu'à laisser croire) : SSO, passkeys (le 2FA par application TOTP est fait, voir §1), API publique, webhooks, mode hors-ligne réel, l'automatisation CI/CD de la §7 (Phase E — le reste de la §7 est fait, voir `todo.md` Phase 27), marketplace de plugins, thème clair si la décision est de rester sombre.
